...
public record AvifOptions(int quality, int alphaQuality, int effort, int threads,
    ...
    /**
     * Creates validated AVIF options.
     *
    ...
    /**
     * Changes colour quality.
     * @param value quality from 0 through 100
     * @return a copy with the selected colour quality
     */
    ...
    /**
     * Changes compression effort.
     * @param value effort from 0 through 10
     * @return a copy with the selected compression effort
     */
    ...
    /**
     * Changes lossless mode.
     * @param value whether lossless mode is enabled
     * @return a copy with lossless mode enabled or disabled
     */
