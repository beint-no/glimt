...
public final class Main {
    public static void main(String[] args) throws Exception {
        var converter = ImageConverter.builder().effort(0).fitWithin(64, 64).build();
        ...
        for (String filename : new String[]{"baseline.jpg", "rgba.png", "lossless.webp", "rgba.heic"}) {
            ...
            if (result.width() != 64 || result.height() != 48 || ImageFormat.detect(result.bytes()) != ImageFormat.AVIF)
